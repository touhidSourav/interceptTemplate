...
function SignInPage() {
  ...
  return (
    <Box className='min-h-screen flex items-center justify-center'>
      ...
      >
        <Box className='w-full sm:w-[50%] md:w-[60%] flex'>
        ...
        <Box className='bg-teal-500 w-[50%] md:w-[40%] rounded-tr-md rounded-br-md hidden sm:flex justify-center items-center text-white'>
          <Stack align='center'>
            <Title>Welcome</Title>
